            ...
            <div class="col-md-8">
                ...
                <form action="{{ route('admin.foods.update', $food->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="fruitName" class="form-control" id="fruitName" placeholder="">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="fruitPrice" class="form-control" id="fruitPrice" placeholder="">
                    </div>
                    <div class="mb-3">
                        <label for="fruitStock" class="form-label fw-bold">Fruit Stock</label>
                        <input type="text" name="fruitStock" class="form-control" id="fruitStock" placeholder="">
                    </div>
