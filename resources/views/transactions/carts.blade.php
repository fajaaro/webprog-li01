    ...
    <div class="container-fluid ">
        <div class=" container-fluid row justify-content-center">
            <div class="col-sm-6">
                ...
                {{-- for each tiap buah yang dibeli --}}
                    <li class="card">
                            ...
                            <div class="col-md-11">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">
                                        ...
                                        <small class="text-muted">Rp. total harga buah </small>
                                    <p class="card-text">
                                </div>
                            </div>
                            {{-- delete button --}}
                        ...
                        <div class="card-body">
                            <p class="card-title d-flex align-items-baseline">
                                ...
                                <span class="fw-bold justify-content-center ms-2 fs-5">
                                    Rp. total harga semua
                                </span>
                            </p>
                            {{-- checkout button --}}
                            <div class="col-md-1 d-flex align-items-center"> <button type="button"
                                    class="btn btn-secondary d-flex align-items-center justify-content-between mt-2">
